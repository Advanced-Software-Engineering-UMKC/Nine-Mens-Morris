...
def test_get_scaled_image_negative(board_gui_fixture):
    board_gui, _ = board_gui_fixture
...
def test_get_cell_clicked_with_right_click(mock_get_pressed, mock_get_pos, board_gui_fixture):
    board_gui, _ = board_gui_fixture
    cell = board_gui.get_cell_clicked()
...
def test_get_cell_clicked_with_no_click(mock_get_pressed, mock_get_pos, board_gui_fixture):
    board_gui, _ = board_gui_fixture
    cell = board_gui.get_cell_clicked()
...
def test_draw_piece(board_gui_fixture):
    ...
    assert piece_exists_at_position(mock_game.screen, board_gui.black_piece_image, position), "Black piece not found at the expected position"
    ...
    assert piece_exists_at_position(mock_game.screen, board_gui.white_piece_image, position), "White piece not found at the expected position"


def piece_exists_at_position(screen, piece_image, position):
...
def test_draw_piece_with_invalid_position(board_gui_fixture):
    board_gui, mock_game = board_gui_fixture
